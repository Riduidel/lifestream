...
public class ReferencesTest {
	...
	@Test
	public void can_find_direct_author_reference() {
	...
	@Test
	public void can_find_fuzzy_author_reference() {
	...
	@Test
	public void can_find_direct_book_reference() {
		Collection<Reference> tested = new References().prepareReferences("a text and a fuzzy reference to "
	...
	@Test
	public void can_find_fuzzy_book_reference() {
		Collection<Reference> tested = new References().prepareReferences("a text and"
